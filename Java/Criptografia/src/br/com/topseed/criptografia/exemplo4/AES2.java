...
public class AES2 {
	...
	public static void main(String args[]) {
		/**
		 * Solicita ao usuário que informe uma chave com caracteres: (256 / 8 = 32) 32
		 * caracteres = 256 bits (192 / 8 = 192) 24 caracteres = 192 bits (128 / 8 =
		 * 128) 16 caracteres = 128 bits
		 */
